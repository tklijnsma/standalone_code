class MEM_Table_configuration:
    ...
    def V12_test(self):
        ...
        self.input_dir = 'V12/V12_LIM_v1'

        self.output_dir = self.input_dir + '_WPtight2'
        ...
        self.x_key_list = [
            ...
            'WPtight2',
            'pass_2qW_def&&WPtight2',
            'nonpass_2qW_def&&WPtight2',
    ...
    def Oldcat_SJcat_pass_nopass(self):
        ...
        self.output_dir = 'A_NEWTF_proper/' + self.input_dir + '_cat1_onlydef'
    ...
    def Set_sel_dict( self ):
        ...
        self.sel_dict = {
            ...
            'WPtight1' : [
                ...
                'httCandidate_AC_n_subjetiness<0.6',
                ],

            'WPtight2' : [
                'httCandidate_AC_fRec<0.10',
                'httCandidate_AC_n_subjetiness<0.5',
                ],
